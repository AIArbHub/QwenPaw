...
- **macOS**: `AI-Arb-<version>-macOS.zip` (khuyên dùng Apple Silicon)
...
- **Cho phép trong System Settings**
  Nếu vẫn bị chặn, vào **System Settings → Privacy & Security**, cuộn đến thông báo như *"AI Arb was blocked because it is from an unidentified developer"*, và nhấp **Open Anyway** hoặc **Allow**.
