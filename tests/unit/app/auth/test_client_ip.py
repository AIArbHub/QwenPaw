...
class TestResolveClientIp:
    ...
    @patch("aiarb.app.auth._get_config_cached")
...
class TestShouldSkipAuthDefenseInDepth:
    ...
    @patch("aiarb.app.auth._get_config_cached")
    @patch("aiarb.app.auth.is_auth_enabled", return_value=True)
    @patch("aiarb.app.auth.has_registered_users", return_value=True)
    def test_loopback_direct_passes(self, _a, _b, mock_cfg):
        from aiarb.app.auth import AuthMiddleware  # noqa: F811
