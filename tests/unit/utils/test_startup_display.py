...
from aiarb.utils.startup_display import AgentStartupDisplay
...
def test_startup_display_prints_final_banner_without_tty() -> None:
    ...
    with patch(
        "aiarb.utils.startup_display.print_ready_banner",
    ) as print_banner:
...
def test_startup_display_preserves_file_logging(tmp_path) -> None:
    ...
    logger = logging.getLogger("aiarb.test.startup_display")
