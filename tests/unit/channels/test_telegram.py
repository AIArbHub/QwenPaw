...
def test_telegram_base_urls_derive_api_and_file_prefixes():
    ...
    from aiarb.app.channels.telegram.channel import _telegram_base_urls
...
def telegram_channel(
    ...
    from aiarb.app.channels.telegram.channel import TelegramChannel
...
class TestTelegramChannelFromConfig:
    ...
    def test_from_config_with_config_object(
        ...
        from aiarb.app.channels.telegram.channel import TelegramChannel
        from aiarb.config.config import TelegramConfig
...
class TestTelegramSendMediaValue:
    ...
    async def test_send_media_value_file_not_found(
        ...
        from aiarb.app.channels.telegram.channel import (
...
class TestTelegramMessageMeta:
    ...
    def test_message_meta_full(self):
        ...
        from aiarb.app.channels.telegram.channel import _message_meta
...
class TestTelegramExceptions:
    ...
    def test_file_too_large_error(self):
        ...
        from aiarb.app.channels.telegram.channel import _FileTooLargeError
...
class TestTelegramPollingReconnect:
    ...
    async def test_teardown_swallows_errors_and_settles(
        ...
        with patch(
            "aiarb.app.channels.telegram.channel.asyncio.sleep",
            new=AsyncMock(),
        ) as mock_sleep:
