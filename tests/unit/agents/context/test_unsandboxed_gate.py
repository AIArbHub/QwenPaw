...
flag AND the deployment-layer ``AIARB_ALLOW_UNSANDBOXED_RECALL`` env var, so
...
from aiarb.agents.context import scroll_unsandboxed_allowed

_ENV = "AIARB_ALLOW_UNSANDBOXED_RECALL"
