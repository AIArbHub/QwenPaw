...
from aiarb.security.tool_guard.models import ToolGuardResult


@pytest.mark.asyncio
async def test_guarded_permissions_offloads_engine_guard():
    """Async permission adapter must not call engine.guard on the loop."""
    from aiarb.runtime.tool_guard import _guarded_tool_check_permissions
    ...
    with (
        ...
        patch(
            "aiarb.runtime.tool_guard.asyncio.to_thread",
