...
The AIArb defence against a malformed ``tool_call.input`` JSON string is
``_coerce_tool_inputs_to_json`` in ``aiarb.agents.utils.tool_message_utils``,
...
from aiarb.framework.message import ToolCallBlock, ToolResultState

from aiarb.agents.utils.tool_message_utils import (
    _coerce_tool_inputs_to_json,
)
from aiarb.tool_calls._coordinator import _parse_tool_input
