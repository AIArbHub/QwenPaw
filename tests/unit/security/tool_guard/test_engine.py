...
"""Tests for aiarb.security.tool_guard.engine."""
...
from aiarb.security.tool_guard.engine import (
    ToolGuardEngine,
    _guard_enabled,
    get_guard_engine,
)
...
def _reset_singleton():
    ...
    import aiarb.security.tool_guard.engine as eng_mod
...
class TestGuardEnabled:
    ...
    @patch("aiarb.security.tool_guard.engine.EnvVarLoader")
...
class TestGetGuardEngine:
    @patch(
        "aiarb.security.tool_guard.engine.ToolGuardEngine",
        autospec=True,
    )
...
class TestSharedSafetyAutoDenyIntegration:
    ...
    def _engine_with_shared_safety(self) -> ToolGuardEngine:
        from aiarb.security.tool_guard.guardians.rule_guardian import (
