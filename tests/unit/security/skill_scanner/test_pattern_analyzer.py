# -*- coding: utf-8 -*-
"""Tests for aiarb.security.skill_scanner.analyzers.pattern_analyzer.
...
from aiarb.security.skill_scanner.analyzers.pattern_analyzer import (
    PatternAnalyzer,
    RuleLoader,
    SecurityRule,
)
...
from aiarb.security.skill_scanner.scan_policy import (
    CredentialPolicy,
    ScanPolicy,
)
