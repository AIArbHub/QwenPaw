...
The guard in ``aiarb.security.tool_guard.guardians.rule_guardian`` extracts
...
def workspace(tmp_path: Path) -> Iterator[Path]:
    ...
    with (
        patch(
            "aiarb.config.context.get_current_workspace_dir",
            return_value=ws,
        ),
        patch(
            "aiarb.security.tool_guard.guardians."
