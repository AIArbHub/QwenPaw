...
from aiarb.agents.tools.delegate_external_agent import (
    delegate_external_agent,
)
from aiarb.agents.tools.file_io import append_file
...
from aiarb.governance.tool_registry import (
    DEFAULT_REGISTRY,
...
from aiarb.runtime.tool_registry import ToolRegistry as RuntimeToolRegistry
from aiarb.plugins.registry import PluginRegistry
from aiarb.runtime.tool_registry import ToolDescriptor, ToolGovernanceSpec
...
class TestBuiltinDescriptorGovernance:
    ...
    def test_empty_tool_type_is_governance_gap(self):
        ...
        with patch(
            "aiarb.runtime.tool_registry.get_builtin_tool_funcs",
            return_value=[fn],
        ):
...
class TestLazyRegistryConcurrency:
    def test_lazy_registry_single_instance_under_contention(self):
        ...
        from aiarb.governance import tool_registry as tr
...
class TestRegisterToolRollback:
    ...
    def test_governance_failure_releases_ownership(self):
        ...
        try:
            ...
            with patch(
                "aiarb.plugins.api._register_to_governance",
    ...
    def test_expose_failure_rolls_back_ownership_and_governance(self):
        ...
        try:
            ...
            with patch(
                "aiarb.plugins.api._bridge_to_runtime",
    ...
    def test_write_config_failure_unbridges_runtime(self):
        ...
        try:
            ...
            with patch(
                "aiarb.plugins.api._write_tool_config",
...
class TestLoaderGovernanceLifecycle:
    ...
    async def test_unload_plugin_allows_metadata_change_reinstall(self):
        from aiarb.plugins.architecture import (
            PluginEntryPoints,
            PluginManifest,
            PluginRecord,
        )
    ...
    async def test_unload_ignores_manifest_tools_not_owned(self):
        ...
        old = PluginRegistry._instance
        PluginRegistry._instance = None
        tools_module = sys.modules["aiarb.agents.tools"]
