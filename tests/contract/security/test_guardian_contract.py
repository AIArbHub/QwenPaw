...
from aiarb.security.tool_guard.guardians import BaseToolGuardian
from aiarb.security.tool_guard.guardians.file_guardian import (
    FilePathToolGuardian,
)
from aiarb.security.tool_guard.guardians.rule_guardian import (
    RuleBasedToolGuardian,
)
from aiarb.security.tool_guard.models import GuardFinding
...
def file_guardian():
    ...
    with patch(
        "aiarb.security.tool_guard.guardians.file_guardian"
