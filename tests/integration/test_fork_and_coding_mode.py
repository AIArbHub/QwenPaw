...
Target routers:
  - src/aiarb/app/routers/coding_mode.py (GET + POST /api/coding-mode)
  - src/aiarb/app/routers/fork.py         (POST /api/fork/agent)
  - src/aiarb/app/routers/agent_status.py (GET agent-scoped)
