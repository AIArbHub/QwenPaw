...
LangString aiarbCliPathPageTitle ${LANG_PORTUGUESEBR} "Command line"
LangString aiarbCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether aiarb is available in terminals."
LangString aiarbCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AIArb Desktop."
LangString aiarbCliPathCheckbox ${LANG_PORTUGUESEBR} "Add aiarb to PATH"
LangString aiarbCliPathAdded ${LANG_PORTUGUESEBR} "Added aiarb to user PATH"
LangString aiarbCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding aiarb to user PATH"
LangString aiarbCliPathMissing ${LANG_PORTUGUESEBR} "aiarb.exe was not found; skipped PATH update"
LangString aiarbCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
LangString aiarbStopProcessesPrompt ${LANG_PORTUGUESEBR} "Processos do AIArb ainda usam arquivos que o instalador precisa substituir.$\n$\nFeche o AIArb e as sessões de linha de comando relacionadas e clique em Repetir. Clique em Cancelar para abortar."
LangString aiarbRestoreInstallStateFailed ${LANG_PORTUGUESEBR} "Não foi possível restaurar o inicializador do Native Messaging; o aiarb tentará novamente na inicialização"
