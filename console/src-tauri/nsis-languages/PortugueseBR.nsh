...
LangString aiarbCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AI Arb Desktop."
...
LangString aiarbStopBackendPrompt ${LANG_PORTUGUESEBR} "O AI Arb  ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o AI Arb  (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
