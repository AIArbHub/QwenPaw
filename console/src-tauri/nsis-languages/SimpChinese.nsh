...
LangString aiarbCliPathPageTitle ${LANG_SIMPCHINESE} "命令行"
LangString aiarbCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 aiarb。"
LangString aiarbCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 aiarb 命令加入你的用户 PATH。之后可通过重新安装或卸载 AIArb Desktop 变更。"
LangString aiarbCliPathCheckbox ${LANG_SIMPCHINESE} "将 aiarb 添加到 PATH"
LangString aiarbCliPathAdded ${LANG_SIMPCHINESE} "已将 aiarb 添加到用户 PATH"
LangString aiarbCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 aiarb 到用户 PATH"
LangString aiarbCliPathMissing ${LANG_SIMPCHINESE} "未找到 aiarb.exe，已跳过 PATH 更新"
LangString aiarbCliPathUpdateFailed ${LANG_SIMPCHINESE} "更新用户 PATH 失败"
LangString aiarbStopProcessesPrompt ${LANG_SIMPCHINESE} "AIArb 进程仍在占用安装程序需要替换的文件。$\n$\n请退出 AIArb 并关闭相关命令行会话，然后点击“重试”；点击“取消”将中止安装。"
LangString aiarbRestoreInstallStateFailed ${LANG_SIMPCHINESE} "无法恢复 Native Messaging 启动器；aiarb 将在下次启动时重试恢复"
