...
LangString qwenpawCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 qwenpaw 命令加入你的用户 PATH。之后可通过重新安装或卸载 AI Arb Desktop 变更。"
...
LangString qwenpawStopBackendPrompt ${LANG_SIMPCHINESE} "AI Arb  仍在运行，正占用安装程序需要替换的文件。$\n$\n请先退出 AI Arb （注意查看系统托盘），然后点击“重试”继续；点击“取消”将中止安装。"
