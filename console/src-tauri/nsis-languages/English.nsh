...
LangString aiarbStopBackendPrompt ${LANG_ENGLISH} "AIArb is still running and is using files the installer needs to replace.$\n$\nPlease quit AIArb (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
