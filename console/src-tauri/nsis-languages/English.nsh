...
LangString qwenpawCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled qwenpaw command to your user PATH. You can change it later by reinstalling or uninstalling AI Arb Desktop."
...
LangString qwenpawStopBackendPrompt ${LANG_ENGLISH} " AI Arb is still running and is using files the installer needs to replace.$\n$\nPlease quit AI Arb (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
