...
LangString aiarbCliPathPageTitle ${LANG_ENGLISH} "Command line"
LangString aiarbCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether aiarb is available in terminals."
LangString aiarbCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AIArb Desktop."
LangString aiarbCliPathCheckbox ${LANG_ENGLISH} "Add aiarb to PATH"
LangString aiarbCliPathAdded ${LANG_ENGLISH} "Added aiarb to user PATH"
LangString aiarbCliPathSkipped ${LANG_ENGLISH} "Skipped adding aiarb to user PATH"
LangString aiarbCliPathMissing ${LANG_ENGLISH} "aiarb.exe was not found; skipped PATH update"
LangString aiarbCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
LangString aiarbStopProcessesPrompt ${LANG_ENGLISH} "AIArb processes are still using files the installer needs to replace.$\n$\nQuit AIArb and close related command-line sessions, then click Retry. Click Cancel to abort."
LangString aiarbRestoreInstallStateFailed ${LANG_ENGLISH} "Could not restore the Native Messaging launcher; AIArb will retry recovery at startup"
