...
LangString aiarbCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AI Arb Desktop."
...
LangString aiarbStopBackendPrompt ${LANG_ENGLISH} " AI Arb is still running and is using files the installer needs to replace.$\n$\nPlease quit AI Arb (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
