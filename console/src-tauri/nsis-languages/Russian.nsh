...
LangString aiarbCliPathPageTitle ${LANG_RUSSIAN} "Command line"
LangString aiarbCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether aiarb is available in terminals."
LangString aiarbCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AIArb Desktop."
LangString aiarbCliPathCheckbox ${LANG_RUSSIAN} "Add aiarb to PATH"
LangString aiarbCliPathAdded ${LANG_RUSSIAN} "Added aiarb to user PATH"
LangString aiarbCliPathSkipped ${LANG_RUSSIAN} "Skipped adding aiarb to user PATH"
LangString aiarbCliPathMissing ${LANG_RUSSIAN} "aiarb.exe was not found; skipped PATH update"
LangString aiarbCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString aiarbStopProcessesPrompt ${LANG_RUSSIAN} "Процессы AIArb всё ещё используют файлы, которые установщику нужно заменить.$\n$\nЗакройте AIArb и связанные сеансы командной строки, затем нажмите «Повторить». Нажмите «Отмена», чтобы прервать установку."
LangString aiarbRestoreInstallStateFailed ${LANG_RUSSIAN} "Не удалось восстановить средство запуска Native Messaging; aiarb повторит попытку при запуске"
