...
LangString aiarbStopBackendPrompt ${LANG_RUSSIAN} "AIArb всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте AIArb (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
