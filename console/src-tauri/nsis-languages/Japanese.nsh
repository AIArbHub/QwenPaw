...
LangString aiarbCliPathPageTitle ${LANG_JAPANESE} "Command line"
LangString aiarbCliPathPageSubtitle ${LANG_JAPANESE} "Choose whether aiarb is available in terminals."
LangString aiarbCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled aiarb command to your user PATH. You can change it later by reinstalling or uninstalling AIArb Desktop."
LangString aiarbCliPathCheckbox ${LANG_JAPANESE} "Add aiarb to PATH"
LangString aiarbCliPathAdded ${LANG_JAPANESE} "Added aiarb to user PATH"
LangString aiarbCliPathSkipped ${LANG_JAPANESE} "Skipped adding aiarb to user PATH"
LangString aiarbCliPathMissing ${LANG_JAPANESE} "aiarb.exe was not found; skipped PATH update"
LangString aiarbCliPathUpdateFailed ${LANG_JAPANESE} "Failed to update user PATH"
LangString aiarbStopProcessesPrompt ${LANG_JAPANESE} "AIArb のプロセスが、インストーラーで置き換えるファイルを使用しています。$\n$\nAIArb と関連するコマンドラインセッションを終了し、「再試行」をクリックしてください。「キャンセル」で中止します。"
LangString aiarbRestoreInstallStateFailed ${LANG_JAPANESE} "Native Messaging ランチャーを復元できませんでした。aiarb の起動時に再試行します"
