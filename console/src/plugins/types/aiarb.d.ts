/**
 * plugins/types/aiarb.d.ts — stable public contract for plugin authors.
 *
 * Plugin TS projects (cloudpaw, aiarb-pet, …) should COPY this file into
 * their own `aiarb-host.d.ts` and uncomment the `declare global` block at
 ...
 *
 * Inside the host, the global `Window.AIArb` is declared in
...
export interface AIArbChatNamespace {
  welcome: {
    set(
      pluginId: string,
      partial: Partial<{
...
export interface AIArbHostNamespace {
...
export interface AIArbAuditNamespace {
...
export interface AIArbWindowNamespace {
  host: AIArbHostNamespace;
...
// Plugin projects: uncomment this in your own aiarb-host.d.ts to type
// `window.AIArb.*` accesses in plugin code.
//
// declare global {
//   interface Window {
//     AIArb: AIArbWindowNamespace;
//   }
// }
