...
// Doc EN URLs per channel (anchors on https://aiarb.cn/docs/channels)
const CHANNEL_DOC_EN_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk:
    "https://aiarb.cn/docs/channels/?lang=en#DingTalk-recommended",
  feishu: "https://aiarb.cn/docs/channels/?lang=en#Feishu-Lark",
  imessage:
    "https://aiarb.cn/docs/channels/?lang=en#iMessage-macOS-only",
  discord: "https://aiarb.cn/docs/channels/?lang=en#Discord",
  qq: "https://aiarb.cn/docs/channels/?lang=en#QQ",
  telegram: "https://aiarb.cn/docs/channels/?lang=en#Telegram",
  mqtt: "https://aiarb.cn/docs/channels/?lang=en#MQTT",
  mattermost: "https://aiarb.cn/docs/channels/?lang=en#Mattermost",
  matrix: "https://aiarb.cn/docs/channels/?lang=en#Matrix",
  sip: "https://aiarb.cn/docs/channels/?lang=en#SIP",
  wecom:
    "https://aiarb.cn/docs/channels/?lang=en#WeCom-WeChat-Work",
  wechat:
    "https://aiarb.cn/docs/channels/?lang=en#WeChat-Personal-iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  yuanbao: "https://aiarb.cn/docs/channels/?lang=en#Yuanbao",
  onebot:
    "https://aiarb.cn/docs/channels/?lang=en#OneBot-v11-NapCat--QQ-full-protocol",
  slack: "https://aiarb.cn/docs/channels/?lang=en#Slack",
};

// Doc ZH URLs per channel (anchors on https://aiarb.cn/docs/channels)
const CHANNEL_DOC_ZH_URLS: Partial<Record<ChannelKey, string>> = {
  dingtalk: "https://aiarb.cn/docs/channels/?lang=zh#钉钉推荐",
  feishu: "https://aiarb.cn/docs/channels/?lang=zh#飞书",
  imessage:
    "https://aiarb.cn/docs/channels/?lang=zh#iMessage仅-macOS",
  discord: "https://aiarb.cn/docs/channels/?lang=zh#Discord",
  qq: "https://aiarb.cn/docs/channels/?lang=zh#QQ",
  telegram: "https://aiarb.cn/docs/channels/?lang=zh#Telegram",
  mqtt: "https://aiarb.cn/docs/channels/?lang=zh#MQTT",
  mattermost: "https://aiarb.cn/docs/channels/?lang=zh#Mattermost",
  matrix: "https://aiarb.cn/docs/channels/?lang=zh#Matrix",
  sip: "https://aiarb.cn/docs/channels/?lang=zh#SIP",
  wecom: "https://aiarb.cn/docs/channels/?lang=zh#企业微信",
  wechat: "https://aiarb.cn/docs/channels/?lang=zh#微信个人iLink",
  xiaoyi:
    "https://developer.huawei.com/consumer/cn/doc/service/openclaw-0000002518410344",
  yuanbao:
    "https://aiarb.cn/docs/channels/?lang=zh#腾讯元宝Yuanbao",
  onebot:
    "https://aiarb.cn/docs/channels/?lang=zh#OneBot-v11NapCat--QQ-完整协议",
  slack: "https://aiarb.cn/docs/channels/?lang=zh#Slack",
};
