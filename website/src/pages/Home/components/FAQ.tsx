...
export function FAQ() {
            ...
            <>
              ...
              <ul className="mt-2 list-disc space-y-1 pl-5">
                ...
                <li>
                  ...
                  <code>pip install --upgrade aiarb</code>
                </li>
                ...
                <li>
                  ...
                  <ul className="mt-1 list-disc space-y-1 pl-5">
                    ...
                    <li>
                      ...
                      <a
                        href="https://github.com/agentscope-ai/AIArb/releases"
                        target="_blank"
          ...
          answer: (
            <>
              <p>
                ...
                <code>aiarb init --defaults</code>
              </p>
              <p>
                {t("homeFaq.quickStart.initialize.p2")} <code>aiarb app</code>
              </p>
              <p className="mt-2">
          ...
          answer: (
            <>
              ...
              <p className="mt-2">
                ...
                <code>aiarb models</code> {t("homeFaq.features.models.p4Mid")}{" "}
                <Link
                  to="/docs/cli#aiarb-models"
                  className="text-(--color-primary) no-underline transition hover:brightness-110"
                >
            ...
            <>
              ...
              <ol className="mt-2 list-decimal space-y-1 pl-5">
                ...
                <li>
                  ...
                  <a
                    href="https://github.com/agentscope-ai/AIArb/issues"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-(--color-primary) no-underline transition hover:brightness-110"
                  >
                  ...
                  <code>aiarb_query_error_qzbx1mv1.json</code>
  ...
  return (
    <motion.section
      ...
      aria-labelledby="aiarb-faq-heading"
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 md:grid-cols-[40%_60%] md:gap-12">
          <motion.div variants={itemVariants}>
            <h2 id="aiarb-faq-heading" className={sectionStyles.title}>
              {t("homeFaq.title")}
            </h2>
            <p
