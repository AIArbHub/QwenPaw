...
const ROW_DIRECTIONS = [
  "aiarb-channels-marquee-left",
  "aiarb-channels-marquee-right",
  "aiarb-channels-marquee-left",
] as const;
  ...
  return (
    <>
      <motion.section
        ...
        aria-labelledby="aiarb-contributors-heading"
      >
        <div className="mx-auto max-w-7xl text-center">
          <motion.h2
            id="aiarb-contributors-heading"
        ...
        <div className="mx-auto max-w-7xl text-center">
          <div
            className="pointer-events-none relative left-1/2 mt-10 h-px w-screen -translate-x-1/2 animate-[aiarb-dash-move-right_1s_linear_infinite]"
            style={{
              background:
