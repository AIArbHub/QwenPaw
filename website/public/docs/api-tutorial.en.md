...
> **Protocol Details**: AIArb's API is based on an extension of the AgentScope Runtime protocol. For more details, see:
...
3. Submit an [Issue](https://github.com/agentscope-ai/AIArb/issues) on GitHub
