...
AIArb is built on **AgentScope 2.0** and uses it as a library. AgentScope provides its runtime in-process, so there is no separate runtime service. AIArb reuses:
