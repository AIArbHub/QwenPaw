# AIArb Agent Team 实践指南

本文档介绍如何使用 AIArb + AgentTeams 构建多智能体协作团队，实现从单一 Agent 到 Agent Team 的能力跃迁。
...
AIArb Team 通过组合 **AIArb** + **[AgentTeams](https://hiclaw.io/)**，提供完整的多 Agent 编排协作方案：

- **AIArb Team Leader**：基于 AIArb 构建，担任团队协调者，负责任务分解、工作分配和结果汇总
- **AIArb Workers**：基于 AIArb 构建，担任任务执行者，专注于特定领域工作，接收 Leader 指令并返回结果
...
- [AIArb 快速开始](./quickstart)
- [AIArb 多智能体](./multi-agent)
- [AIArb Skills](./skills)
...
AIArb Agent Team 通过 AIArb 和 AgentTeams 的结合，为个人开发者和小型团队提供了强大的多智能体协作能力。通过合理的团队设计和任务分配，可以显著提升工作效率，实现"一个人的团队"。
