# AIArb Agent Team Practice Guide

This guide introduces how to build multi-agent collaborative teams using AIArb + AgentTeams, achieving the capability leap from single Agent to Agent Team.
...
AIArb Team provides a complete multi-Agent orchestration and collaboration solution by combining **AIArb** + **[AgentTeams](https://hiclaw.io/)**:

- **AIArb Team Leader**: Built on AIArb, serves as team coordinator, responsible for task decomposition, work allocation, and result aggregation
- **AIArb Workers**: Built on AIArb, serve as task executors, focusing on domain-specific work, receiving Leader instructions and returning results
...
- [AIArb Quick Start](./quickstart)
- [AIArb Multi-Agent](./multi-agent)
- [AIArb Skills](./skills)
...
AIArb Agent Team, through the combination of AIArb and AgentTeams, provides powerful multi-agent collaboration capabilities for individual developers and small teams. Through proper team design and task allocation, work efficiency can be significantly improved, achieving a "one-person team."
