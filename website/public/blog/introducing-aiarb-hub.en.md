---
title: "AIArb Hub: Run AIArb for Your Team on Your Own Server"
date: 2026-08-19
author: AIArb Team
tags: [AIArb Hub, Self-hosted, Multi-user, Docker]
excerpt: "AIArb 2.2.0 introduces Hub, a self-hosted entry point that gives every team member their own QwenPaw."
related:
  heading: "Deploy AIArb Hub"
  description: "Install version 2.2.0 or later, initialize an administrator, and invite your team."
  items:
    - label: "Documentation"
      name: "AIArb Hub documentation" 
      href: "/docs/hub"
---

# AIArb Hub: Run AIArb for Your Team on Your Own Server 
 
Starting with AIArb 2.2.0, non-desktop installations include AIArb Hub. It lets you run AIArb for a team on infrastructure you control.
...
## A personal AIArb for every team member

Without Hub, offering AIArb to a team usually means operating separate instances by hand. Accounts, ports, data directories, and processes all need individual attention, and the work grows with the team.
...
flowchart LR
    ...
    Lifecycle --> R1[User A AIArb]
    Lifecycle --> R2[User B AIArb]
    Proxy --> R1
    Proxy --> R2
    R1 --> D1[User A data]
    R2 --> D2[User B data]
