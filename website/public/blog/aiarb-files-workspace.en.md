---
title: "AIArb Files: One Place for Your Agent's Work, Profile, and Memory"
date: 2026-08-17
author: AIArb Team
...
excerpt: "AIArb Files brings the workspace, profile, daily notes, and knowledge base into one view, so you can see what an Agent is using, what it remembers, and how those records become reusable knowledge."
---

# AIArb Files: One Place for Your Agent's Work, Profile, and Memory

Suppose you ask AIArb to help prepare a product release.
...
None of this has to remain scattered across chat history. AIArb stores project materials, Agent profile files, daily records, and long-term knowledge as files you can inspect directly. **Files** gives you one place to view and manage them all.

![An overview of the AIArb Files workspace](https://img.alicdn.com/imgextra/i4/O1CN01GjiXT3fTIrJ5Bkx9_!!6000000006529-2-tps-2556-1223.png)
...
When you ask AIArb to prepare release notes, the customer interviews, changelog, and generated Markdown can all live in Workspace. You do not have to guess which conversation contains a file or download it before opening it.
...
You can open and edit these files, enable or disable them, and change their order. If you want AIArb to use less jargon and lead with user value in release notes, you can put that durable instruction in the appropriate profile file.
...
Once you find a file, you do not have to leave AIArb to continue working with it.
...
When you reference a file, AIArb preserves its path and, where relevant, its line information. If you say “rewrite this section,” the Agent can identify the exact file and passage instead of relying on copied text detached from its source.
...
3. AIArb drafts the release notes; you read them in Preview and adjust the wording in Edit.
...
- [AIArb #6504: Unified Files Workspace](https://github.com/agentscope-ai/AIArb/pull/6504)
