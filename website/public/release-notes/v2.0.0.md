...
- **Runtime 2.0**: Refactor the kernel based on AIArb 2.0 ([#5078](https://github.com/agentscope-ai/QwenPaw/pull/5078), [#4846](https://github.com/agentscope-ai/QwenPaw/pull/4846), [#5018](https://github.com/agentscope-ai/QwenPaw/pull/5018), [#5552](https://github.com/agentscope-ai/QwenPaw/pull/5552))
...
- **Native Compression**: Refactor using AIArb 2.0's built-in context compression strategy ([#5309](https://github.com/agentscope-ai/QwenPaw/pull/5309))
...
- **Full-screen TUI**: A textual-based terminal chat app (`aiarb tui`) — streaming output, tool-call rendering, status bar, and session management all in the terminal ([#5032](https://github.com/agentscope-ai/QwenPaw/pull/5032))
...
- **AIArb middleware hooks**: Plugins can register AIArb-compatible middleware with semver versioning ([#5221](https://github.com/agentscope-ai/QwenPaw/pull/5221))
- **Version-gated catalog**: Plugin market and CDN only show plugins compatible with the running AIArb version ([#5661](https://github.com/agentscope-ai/QwenPaw/pull/5661))
...
- Workspace prompt files (`.aiarb.md`) and skill injection restored in system prompt assembly ([#5396](https://github.com/agentscope-ai/QwenPaw/pull/5396), [#5680](https://github.com/agentscope-ai/QwenPaw/pull/5680))
...
- AIArb review bot auto-comments on PRs with lint/style findings ([#5736](https://github.com/agentscope-ai/QwenPaw/pull/5736))
...
- E2E adapted for AIArb 2.0 ([#5542](https://github.com/agentscope-ai/QwenPaw/pull/5542))
