...
- **PawApp SDK & Kanban App**: A new mini-app platform that lets plugins build rich interactive UIs on top of AIArb. Ships with a built-in Kanban task board app for project management ([#6150](https://github.com/agentscope-ai/QwenPaw/pull/6150))
