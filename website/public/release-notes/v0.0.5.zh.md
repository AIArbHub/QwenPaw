...
- **本地文件路径**：修复 aiarb 集成中音频/图片/视频本地文件路径处理 ([#627](https://github.com/agentscope-ai/CoPaw/pull/627))
...
- **AIArb 版本兼容**：适配 AIArb 1.0.16 正式版 ([#699](https://github.com/agentscope-ai/CoPaw/pull/699))
