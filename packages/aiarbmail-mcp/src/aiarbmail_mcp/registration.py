...
def build_registration_guide(
    ...
    if provider_type == "netease":
        steps = [
            ...
            f"8. Set AIARBMAIL_EMAIL={email} and "
            "AIARBMAIL_AUTH_CODE=<your_authorization_code>.",
        ...
        if domain == "foxmail.com":
            steps = [
                ...
                f"7. Set AIARBMAIL_EMAIL={email} and "
                "AIARBMAIL_AUTH_CODE=<your_authorization_code>.",
    ...
    return {
        ...
        "next_action": (
            ...
            "alternatives. 2. After registration, set AIARBMAIL_EMAIL and "
            "AIARBMAIL_AUTH_CODE, then call check_auth to verify "
            "connectivity."
        ),
    }
