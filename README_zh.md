...
[![GitHub Star](https://img.shields.io/github/stars/agentscope-ai/AIArb?style=flat&logo=github&color=yellow&label=Star)](https://github.com/agentscope-ai/AIArb/stargazers)
[![GitHub Fork](https://img.shields.io/github/forks/agentscope-ai/AIArb?style=flat&logo=github&color=purple&label=Fork)](https://github.com/agentscope-ai/AIArb/network)
...
镜像在 **Docker Hub**（`agentscope/aiarb`）。镜像 tag：`latest`（稳定版）；`pre`（PyPI 预发布版）。
...
国内用户也可选用阿里云容器镜像服务 (ACR)：`agentscope-registry.ap-southeast-1.cr.aliyuncs.com/agentscope/aiarb`（tag 相同）。
...
[AgentScope Platform](https://platform.agentscope.io/) 提供一键云端 AIArb 部署、插件分享与 Skill 市场。完全免费，7/24 在线。

---

### 方式六：使用魔搭创空间

使用 [魔搭创空间](https://modelscope.cn/studios/fork?target=AgentScope/AIArb) 也可进行云端 AIArb 部署。注意：请将创空间设为 **非公开**，否则他人可能操纵你的 AIArb。
...
AIArb 在开放协作中持续演进，欢迎各种形式的参与！请参考上方 [路线图](#路线图)（尤其是标记为 **征集中** 的项）选择你感兴趣的方向，并阅读 [CONTRIBUTING](https://github.com/agentscope-ai/AIArb/blob/main/CONTRIBUTING_zh.md) 了解如何开始。我们特别欢迎：

- **横向拓展** — 新频道、模型提供商、Skills、MCP。
- **已有功能扩展与完善** — 展示与交互优化、下载提示、Windows 路径兼容等。

欢迎在 [GitHub Discussions](https://github.com/agentscope-ai/AIArb/discussions) 参与讨论、提出想法或认领任务。
...
<a href="https://github.com/agentscope-ai/AIArb/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=agentscope-ai/AIArb" alt="贡献者" />
</a>
