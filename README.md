...
Images are on **Docker Hub** (`agentscope/aiarb`). Image tags: `latest` (stable); `pre` (PyPI pre-release).
...
Also available on Alibaba Cloud Container Registry (ACR) for users in China: `agentscope-registry.ap-southeast-1.cr.aliyuncs.com/agentscope/aiarb` (same tags).
...
[AgentScope Platform](https://platform.agentscope.io/) provides one-click cloud AIArb deployment, plugin sharing, and a Skill marketplace. Free, 7/24 online.

---

### Option 6: Using ModelScope

[ModelScope Studio](https://modelscope.cn/studios/fork?target=AgentScope/AIArb) also supports cloud AIArb deployment. Note: set your Studio to **non-public** so others cannot control your AIArb.
...
- **Allow in System Settings**
  If it is still blocked, go to **System Settings → Privacy & Security**, scroll to the message like *"AIArb was blocked because it is from an unidentified developer"*, and click **Open Anyway** or **Allow**.
...
Join [GitHub Discussions](https://github.com/agentscope-ai/AIArb/discussions) to discuss ideas or pick up tasks.
...
<a href="https://github.com/agentscope-ai/AIArb/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=agentscope-ai/AIArb" alt="Contributors" />
</a>
