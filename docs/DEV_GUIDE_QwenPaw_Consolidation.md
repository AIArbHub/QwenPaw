...
本次升级对 QwenPaw 控制台进行了全面改造，包括菜单结构调整、功能整合、新增功能、UI/UX 优化和数据持久化设计。
...
**文件**: `src/qwenpaw/cases/models.py`
...
- PRD 文档: `docs/PRD_QwenPaw_Consolidation.md`
- API 接口文档: 参见各 `api/modules/*.ts` 文件
- 模型定义: 参见 `src/qwenpaw/**/models.py` 文件
