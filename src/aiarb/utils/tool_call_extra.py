...
``AIArbAgent._save_to_context`` moves it into the owning ``Msg.metadata``
...
TOOL_CALL_EXTRAS_METADATA_KEY = "_aiarb_tool_call_extras"
_TRANSIENT_TOOL_CALL_EXTRA_ATTR = "_aiarb_tool_call_extra"
