...
class BaseChannel(ABC):
    ...
    def doctor_connectivity_notes(
        ...
        *,
        ...
        """Optional ``aiarb doctor --deep`` reachability checks.
    ...
    def build_agent_request_from_user_content(
        ...
        Uses :mod:`aiarb.schemas` Message / Content types directly — no
    ...
    def _model_fallback_events(event: Any) -> List[Dict[str, str]]:
        ...
        raw_events = event_source.get("aiarb_model_fallbacks")
    ...
    def _clear_session_turn_usage(session_id: str) -> None:
        ...
        mod = importlib.import_module("aiarb.token_usage.model_wrapper")
        ...
        *,
        ...
        try:
            ...
            turn_usage = importlib.import_module(
                "aiarb.token_usage.turn_usage",
            )
            token_usage = importlib.import_module("aiarb.token_usage")
    ...
    async def send_approval_notification(
        ...
        *,
        ...
        back to plain text.
        """
        from aiarb.schemas import AgentRequest, Event
