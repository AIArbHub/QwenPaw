...
from .local_workspace import AIArbLocalWorkspace
...
class Workspace:
    ...
    def __init__(self, agent_id: str, workspace_dir: str):
        ...
        self._local_workspace = AIArbLocalWorkspace(
    ...
    @property
    def local_workspace(self) -> AIArbLocalWorkspace:
        """the framework LocalWorkspace routing tools to ToolRegistry."""
    ...
    def _register_services(  # pylint: disable=too-many-statements
        ...
        sm.register(
            ServiceDescriptor(
                ...
                # reme depends on `framework.token`, which the framework no
