# -*- coding: utf-8 -*-
"""AIArb application approval gate for Driver policy."""
...
class AIArbDriverApprovalGate:
    """Bridge Driver policy approval requests into AIArb approval service."""

    async def request_approval(
        self,
        context: DriverInvocationContext,
    ) -> None:
        # Reuse AIArb's approval Future flow: this coroutine pauses until
