...
1. deterministic rules (case-insensitive substring match) executing
   ...
   ``notify`` via :func:`aiarb.app.inbox_store.append_event`;
...
# Same parameter style as the aiarbmail-mcp mail client.
_ID_COMMAND_ARGS = (
    '("name" "aiarbmail-mcp" "version" "0.1.0" "vendor" "aiarb")'
)
