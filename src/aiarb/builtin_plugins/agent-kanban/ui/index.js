 ...
 * antd come from window.AIArb.host (no bundler in this context).
 *
...
(function () {
  ...
  if (!AIArb || !AIArb.host || !AIArb.registerRoutes) {
    console.error("[agent-kanban] window.AIArb not ready — cannot register.");
    return;
  }
  ...
  // ── Self-register route ─────────────────────────────────────────────────
  AIArb.registerRoutes("agent-kanban", [
    {
