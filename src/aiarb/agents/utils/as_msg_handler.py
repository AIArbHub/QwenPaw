...
"""Token counting and block-level statistics for the framework messages.
...
class AsMsgHandler:
    """Byte-estimation based token accounting for the framework messages.
    ...
    async def stat_message(self, message: Msg) -> AsMsgStat:
        ...
        for block in message.content:
            # the framework 2.0 returns Pydantic block models (TextBlock,
