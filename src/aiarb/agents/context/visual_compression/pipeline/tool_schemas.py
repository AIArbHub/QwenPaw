# -*- coding: utf-8 -*-
"""AIArb-native tool documentation compression.

AIArb's built-in tools are ordinary Python functions. AgentScope derives
...
def plan_aiarb_tool_documentation(
    tools: list[dict],
) -> tuple[list[dict], str]:
    ...
    if rendered:
        rendered = (
            "=== TOOL REFERENCE ===\n"
            "AIArb moved optional-parameter descriptions here to reduce "
...
__all__ = ["plan_aiarb_tool_documentation"]
