...
The default agent behavior is the framework-native compression; injecting a
...
_UNSANDBOXED_ENV = "AIARB_ALLOW_UNSANDBOXED_RECALL"
...
def scroll_unsandboxed_allowed(scroll_config: Any) -> bool:
    ...
    is gated by the deployment-layer ``AIARB_ALLOW_UNSANDBOXED_RECALL`` env
