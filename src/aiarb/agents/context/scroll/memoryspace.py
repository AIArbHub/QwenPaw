...
module name, without the rest of aiarb on the path.
...
# Values must match SYNTHETIC_USER_MESSAGE_TAGS in aiarb.constant (this
...
class MemorySpace:
    ...
    def _raw_saved_tool_refs(
        ...
        if isinstance(parsed, dict):
            by_block = parsed.get("aiarb_truncation")
