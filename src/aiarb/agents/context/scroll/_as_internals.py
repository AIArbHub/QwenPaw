# -*- coding: utf-8 -*-
"""Thin adapter over the the framework 2.0 *private* methods the scroll manager
depends on.

the framework 2.0 is alpha; ``_prepare_model_input`` and
...
async def prepare_model_input(agent: Any) -> dict:
    """The kwargs the framework would pass to the model for the next step."""
