...
6. 分别梳理案件中各方当事人主张的支持事由。即各方基于哪些事实、证据和法律依据来支撑自己的立场。
   ...
   这一环节通常包括：申请人主张所依赖的关键事实是什么；被申请人抗辩所依赖的关键事实是什么；各方分别援引了哪些证据；各方主张分别试图对应哪些法律规范或法律效果。
...
- Format 2：未经过法律事实提取的案件事实陈述。
  ...
  输入也可以是裁决书案情摘要、庭审争议陈述、代理意见摘要、咨询记录或案例材料等，其中包含申请人主张、被申请人抗辩、证据情况和初步法律分歧。这类输入适合进一步从事实结构中提炼争议焦点。
...
- 示例 2：
  ...
  申请人称其在二手平台购买一台电脑时，卖家明确表示系‘全新未拆封’；被申请人则主张自己从未承诺该电脑为全新，仅称‘外观良好’。申请人收货后发现主板存在维修痕迹，并请求退货退款。

- 示例 3：

  请根据这段案件摘要，按照‘核心争点—次级争点—背景性分歧’的层级，整理本案争议焦点：

  申请人主张某平台未经同意向第三方披露其手机号，导致其遭受持续骚扰；被申请人平台主张涉案信息不属于个人敏感信息，且申请人未能证明骚扰结果与平台行为之间存在因果关系。

- 示例 4：

  请根据下面的庭审争议陈述，梳理双方各自主张的支持事由，并将其对应到各个争议焦点之下：

  申请人主张合同已成立并已履行付款义务；被申请人主张合同尚未生效，且即使生效，其未履行亦因申请人先违约所致。
...
当用户提供案情、申请仲裁状、答辩状、庭审笔录、裁决书、证据目录或客户陈述，并要求“归纳争议焦点、提炼焦点、整理庭审争点、找核心问题、做案件分析框架”时，使用本 Skill。

### 工作区流程

1. 读取当前对话、附件和工作区中的案情材料，先识别请求、抗辩、反请求、证据争议和程序争议。
2. 把事实分歧、证据分歧、法律适用分歧、责任范围分歧分开，不要把所有矛盾混成一个大焦点。
3. 为每个争点关联：支持该争点的事实来源、对应证据、可能适用规范、对最终请求的影响。
4. 对复杂案件输出核心争点、次级争点、背景分歧三级结构；对庭审准备任务，额外输出发问方向和补证清单。

### 交付物

输出“争议焦点矩阵”：争点表述、争点类型、申请人主张、被申请人抗辩、关键证据、适用规范、证明责任、对裁判结果的影响、下一步动作。

### 质量检查

- 争点是否围绕请求权、抗辩或责任范围，而不是复述事实？
- 是否区分事实争议、证据争议和法律争议？
- 每个争点是否能被仲裁机构或仲裁庭实际审理判断？
