...
| **输出** | 结构化的论证链条，可包含三段论、类比论证、归纳论证、证据链论证、价值衡量等多种推理路径；若使用三段论，仅作为内部逻辑校验工具，不强制在最终文书中显式标注“法律依据/事实依据/结论” |
...
## 一、核心概念
> **重要原则：** 本技能提供的是一种结构化论证思路，不是强制模板。法律文书的最终表达应当根据案件特点、受众和诉讼策略灵活选择，可以综合运用三段论、证据链论证、类比论证、归谬论证、价值衡量等多种方法。严禁在每一份文书中机械套用固定格式，尤其禁止在上诉状、代理词、辩护词等仲裁文书中逐条标注“法律依据—事实依据—结论”。
...
每个论证节点（Argument Node）应包含三个内在要素，但呈现方式需根据文书类型和论证策略灵活选择：
...
> **重要：** 三段论（法律依据-事实依据-结论）是检验论证逻辑有效性的内部工具，不是法律文书的唯一写法。起草上诉状、代理词、辩护词等仲裁文书时，应优先采用仲裁员易于接受的叙事和论证节奏：先点明主张，再陈述关键事实与证据，最后援引法律规范得出结论。严禁在每一份文书中机械套用“法律依据：……；事实依据：……；结论：……”的固定格式。

### 1.3 论证链条与论证节点的关系

```
论证节点A的结论 ──→ 论证节点B的事实依据（或法律依据的一部分）
                         │
                         ▼
                    论证节点B的结论 ──→ 论证节点C的事实依据
                                            │
...
| **前提真实性** | 法律依据（法律规范）和事实依据（事实）均为真或有充分依据 | 核实法条现行有效性、事实有证据支撑 |
...
问自己：
□ 我要证明什么？（最终结论是什么？）
□ 我在为谁论证？（申请人/被申请人/第三人/仲裁机构？）
□ 目标受众是谁？（仲裁员/仲裁员/对方当事人/客户？）
...
□ 案件事实是否完整涵盖了法律依据中法律规范的构成要件？
```

**6c. 执行涵摄（Subsumption）**

涵摄是将事实依据（事实）归入法律依据（法律规范）的过程：

```
涵摄操作模板：
法律依据：法律规范R规定，当满足要件a、b、c时，产生法律效果E。
事实依据：
  - 本案事实F1满足要件a，因为[具体理由]
  - 本案事实F2满足要件b，因为[具体理由]
  - 本案事实F3满足要件c，因为[具体理由]
...
| 薄弱类型 | 强化方法 |
|----------|----------|
| 法律依据不确定 | 补充法律解释论证、引用权威学说、援引类案 |
| 事实依据有争议 | 补充证据分析、运用经验法则、引用举证责任规则 |
...
论证表达规范：
□ 每个论证节点用独立段落或小节呈现
□ 明确标注法律依据的法律依据（精确到条款项）
□ 明确标注事实依据的事实依据（精确到证据编号）
...
```
准入检验（全部通过方可纳入）：
[必须] 法律依据有明确的法律依据或公认的法律原则
[必须] 事实依据有证据支撑或属于无争议事实
[必须] 结论能从前提中逻辑地推出
[必须] 该节点与论证链条中其他节点不矛盾
...
|------|----------|----------|------|----------|
| F01 | **法条失效** | 引用已被废止或修改的法条作为法律依据 | 整个论证节点无效 | 每次引用法条前核实现行有效性 |
...
| F05 | **事实无据** | 事实依据中的事实没有证据支撑 | 论证基础不牢 | 每个事实主张标注对应证据 |
...
**置信度：** 🟡 中——违约金是否过高属于仲裁机构裁量范围，存在一定不确定性。但从金额比例和行业惯例来看，被调减的可能性较低。
...
- 整体评价：论证链条完整，逻辑清晰，主要风险在于仲裁机构对违约金调减的裁量权
...
**风险提示：**
1. 仲裁机构对违约金调减享有裁量权，不同仲裁机构的裁判尺度可能不同
...
根据司法实践中的"实质审查"原则，判断是否违反竞业限制义务，应当穿透形式审查实质关系。劳动者虽未以自己名义设立竞争企业，但实际控制、参与经营竞争企业的，仍构成违反竞业限制义务。（参考：多地仲裁庭裁判观点，如北京、上海、深圳等地仲裁机构在类似案件中的裁判立场）
...
**置信度：** 🟡 中——时间线的精确认定至关重要。如果能证明张某的违约行为确实发生在A公司停付补偿金之前或同时，论证较为有力。但如果仲裁庭认为A公司停付补偿金本身构成根本违约，可能影响对张某违约责任的认定。
...
**法律依据：**
关于竞业限制违约金的调整，《劳动合同法》未作明确规定。司法实践中，仲裁机构通常参考以下因素综合判断：（1）劳动者的工资收入水平；（2）竞业限制补偿金的数额；（3）劳动者违约行为的性质和程度；（4）用人单位因劳动者违约所遭受的实际损失；（5）劳动者的支付能力；（6）公平原则。

部分仲裁机构参照适用《民法典》第五百八十五条第二款关于违约金调整的规定。
...
**置信度：** 🟡 中——违约金是否合理属于仲裁机构裁量范围。100万元的金额在竞业限制案件中属于较高水平，存在被适当调减的可能。但考虑到张某的高管身份、刻意规避的恶意以及潜在损失的严重性，维持原额或仅小幅调减的可能性较大。
...
- 整体评价：论证链条完整，逻辑自洽，但整体置信度受制于证据状况和仲裁机构裁量
...
2. **补偿金风险：** A公司应尽快补付竞业限制补偿金，避免因持续不支付而被张某反请求解除竞业限制协议
3. **违约金调减风险：** 100万元违约金存在被仲裁机构适当调减的可能，建议同时准备实际损失的证据
4. **执行风险：** 即使获得继续履行的裁决，实际执行可能面临困难
