...
| 术语 | 定义 | 示例 |
|------|------|------|
| **目标变量（Target Variable）** | 被假设改变或移除的事实/行为/条件 | "被申请人的超速驾驶行为" |
| **结果变量（Outcome Variable）** | 需要观察是否变化的法律后果 | "申请人的人身损害" |
| **反事实世界（Counterfactual World）** | 目标变量被改变后的假设情境 | "被申请人以正常速度行驶的世界" |
| **现实世界（Actual World）** | 实际发生的事实状态 | "被申请人超速行驶并撞伤申请人" |
| **背景条件（Background Conditions）** | 在反事实推理中保持不变的其他事实 | "当时的天气、路况、申请人的位置" |
| **But-for因果关系** | "若非"检验——若非A，则B不会发生 | "若非被申请人超速，碰撞不会发生" |
...
```
错误示例："如果被申请人没有做错事" → 过于模糊
正确示例："如果被申请人在2023年3月15日未将含有缺陷的产品投入市场" → 具体可操作

错误示例："如果情况不同" → 无法操作
正确示例："如果被申请人在施工时按照GB50300标准设置了安全围挡" → 具体可操作
```
...
现实世界事实清单：
  F1: 2023年3月15日，晴天
  F2: 被申请人以80km/h速度行驶（限速60km/h）← 目标变量
  F3: 申请人正在人行横道上行走
  F4: 路面干燥
  F5: 被申请人车辆制动系统正常
  ...
...
反事实世界：
  ...
  F2': 被申请人以60km/h速度行驶 ← 目标变量改变
  F3: 申请人正在人行横道上行走 ← 保持不变
  F4: 路面干燥 ← 保持不变
  F5: 被申请人车辆制动系统正常 ← 保持不变
  ...
```
...
检验问题：目标变量的改变在物理上和逻辑上是否可能？
  ✓ 有效："如果被申请人没有闯红灯"（行为可以不同）
  ✗ 无效："如果被申请人不是人类"（物理上不可能的替代）
...
检验问题：反事实世界是否仅在目标变量上与现实世界不同？
  ✓ 有效：仅改变被申请人的驾驶速度，其他条件不变
  ✗ 无效：改变被申请人的驾驶速度的同时，假设天气也变好了
...
示例：申请人主张"如果被申请人没有延迟交货，我就能获得100万利润"
...
**场景描述：** 被申请人主张"即使我没有实施侵权行为，同样的损害也会因为其他原因发生"
...
假设因果关系抗辩：
  ...
  示例：被申请人虽然砍了树，但如果被申请人不砍，暴风雨也会把树吹倒
  → 通常不能否定因果关系（因为实际上是被申请人的行为导致了结果）
...
2024年1月10日下午3时，被申请人张某驾驶小型轿车沿某市解放路由东向西行驶，行至解放路与和平路交叉口时，闯红灯通过路口。此时，申请人李某正沿和平路由南向北在绿灯状态下通过人行横道。张某车辆与李某发生碰撞，导致李某左腿骨折，住院治疗45天，产生医疗费8万元、误工费3万元。
...
2. 责任比例的确定涉及法律政策判断，不同仲裁机构可能有不同的裁量空间
3. 本案中"机会丧失"理论的适用在中国司法实践中尚存争议，部分仲裁机构可能采用不同的分析框架
