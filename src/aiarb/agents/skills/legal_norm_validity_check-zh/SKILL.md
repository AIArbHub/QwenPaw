...
> 上述工具核验结果应纳入「4.2 信息源可靠性分级」一并权衡。默认优先使用已配置的北大法宝 MCP；仅当用户明确要求官方复核、北大法宝无结果或不同来源对效力状态存在重大冲突时，才按需查询[国家法律法规数据库](https://flk.npc.gov.cn)，不得作为每次调研的强制交叉比对步骤。
