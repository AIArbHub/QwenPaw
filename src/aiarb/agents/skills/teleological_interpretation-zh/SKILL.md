...
case_summary: "甲乙均为业余足球爱好者，参加社区业余足球赛。乙在争抢球时采用飞铲动作，致甲右腿胫骨骨折。甲申请仲裁要求赔偿，乙以自甘风险条款抗辩。争议焦点：乙的飞铲是否构成'重大过失'。"
...
1. 从用户问题、附件或工作区文件中确定待解释条文、争议事实和 competing interpretations。
2. 分别整理文义可能性、体系位置、制度目的、保护法益、可能的政策后果。
3. 对每一种解释路径说明：支持理由、限制理由、与上位法/相邻规范是否协调、对个案结论的影响。
4. 若缺少立法资料、司法解释或类案支撑，标注需要进一步检索。

### 质量检查

- 是否先限定文义可能范围，再谈目的？
- 目的来源是否可追溯到制度结构、立法材料、司法解释或法益保护？
- 是否比较了至少两种解释方案？
- 是否说明目的解释与体系解释、规范意义解释的关系？
