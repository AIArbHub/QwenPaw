---
name: browser
description: "Drive a live browser with async Python against AIArb's builtin Browser SDK. The full reference is below; re-load this browser skill after context compaction."
metadata:
...
This is AIArb's builtin Browser SDK, not Playwright. Its surface is closed:
...
AIArb Browser SDK — complete reference. This is AIArb's OWN internal
