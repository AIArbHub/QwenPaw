...
| 6 | 仲裁时效/除斥期间 | **仲裁时效** / **除斥期间** | 《民法典》第188条、第199条 | 仲裁时效可中断中止；除斥期间不变期间，届满权利消灭 |
...
| 序号 | ❌ 错误/不规范表达 | ✅ 规范表达 | 法源依据 | 说明 |
|---|---|---|---|---|
| 11 | 犯罪嫌疑人/被申请人人（混用） | **犯罪嫌疑人**（侦查、审查申请仲裁阶段）/ **被申请人人**（审判阶段） | 《刑事诉讼法》第12条等 | 阶段不同称谓不同，不可混用 |
...
### 4.4 高频易混术语对照表（仲裁程序领域）

| 序号 | ❌ 错误/不规范表达 | ✅ 规范表达 | 法源依据 | 说明 |
|---|---|---|---|---|
| 24 | 申请人/申请人（混用） | **申请人**（诉讼）/ **申请人**（仲裁/非讼程序） | 《仲裁法》/《仲裁法》 | 程序不同称谓不同 |
| 25 | 上诉/申诉/申请再审 | 分别使用 | 《仲裁法》相关章节 | 上诉针对未生效裁决；申请再审针对已生效裁决 |
| 26 | 决定/裁决/决定 | 分别使用 | 《仲裁法》 | 决定解决程序问题；裁决解决实体问题；决定解决诉讼指挥问题 |
| 27 | 管辖/管辖权 | 视语境使用 | 《仲裁法》第二章 | "管辖"指制度；"管辖权"指具体仲裁机构的权限 |
| 28 | 证据/证明/证明力 | 分别使用 | 《仲裁法》第六章 | 证据为材料；证明为活动；证明力为证据的效力强度 |
| 29 | 驳回申请仲裁/驳回仲裁请求 | 分别使用 | 《仲裁法》 | 驳回申请仲裁：不符合申请仲裁条件（决定）；驳回仲裁请求：实体无理由（裁决） |
...
| 43 | 追诉时效/仲裁时效 | **追诉时效**（刑事）/ **仲裁时效**（民事） | 《刑法》第87条/《民法典》第188条 | 分属不同法律部门，不可混用 |
...
|---|---|---|---|---|---|
| F-01 | 主体称谓错误 | 审判阶段称"犯罪嫌疑人" | "被申请人人" | 文书效力瑕疵 | 根据仲裁阶段确定称谓 |
...
| F-07 | 仲裁时效与除斥期间混淆 | "撤销权的仲裁时效" | "撤销权的除斥期间" | 法律适用根本错误 | 形成权适用除斥期间，请求权适用仲裁时效 |
| F-08 | 裁判文书类型错误 | 驳回申请仲裁用"裁决" | "决定" | 文书形式违法 | 程序问题用决定，实体问题用裁决 |
...
| 5 | 第5.3条 | 打官司 | **向有管辖权的人民法院提申请仲裁讼** | 文体不当 | "打官司"为口语化表达 | 🟡警告 |
| 6 | 第5.3条 | 诉讼有效期为两年 | **仲裁时效期间为三年** | 术语错误+内容错误 | ①"诉讼有效期"应为"仲裁时效期间"；②《民法典》第188条规定普通仲裁时效为三年，非两年 | 🔴致命 |
...
3. 双方因履行本合同发生争议的，可**向有管辖权的人民法院提申请仲裁讼**。
   本合同项下纠纷的**仲裁时效期间**依照法律规定执行。
...
依法可以减轻处罚。
    ...
    二、关于量刑
    犯罪嫌疑人王某犯罪情节较轻，建议仲裁机构判处缓期执行。王某已向被害方赔偿
了全部损失并取得谅解，具有悔过表现。
...
| 序号 | 原文位置 | 原始表达 | 修正表达 | 修正类型 | 修正理由 | 严重程度 |
|---|---|---|---|---|---|---|
| 1 | 全文（7处） | 犯罪嫌疑人 | **被申请人人** | 术语错误 | 辩护词在审判阶段提交，此时应称"被申请人人"而非"犯罪嫌疑人"（《刑事诉讼法》第12条：未经人民法院依法裁决，对任何人都不得确定有罪） | 🔴致命 |
...
| 7 | 第三部分 | 附带民事赔偿 | **附带仲裁赔偿** 或 **民事赔偿** | 术语不精确 | 应明确是否提起了刑事附带仲裁（《刑事诉讼法》第101条） | 🟡警告 |
| 8 | 第三部分 | 精神赔偿金 | **精神损害赔偿**（注：刑事附带仲裁中一般不支持） | 术语不精确+法律适用问题 | ①规范表述为"精神损害赔偿"；②根据司法解释，刑事附带仲裁一般不受理精神损害赔偿请求 | 🔴致命 |
...
尊敬的首席仲裁员、审判员：
    ...
    北京XX律师事务所接受**被申请人人**王某的委托，指派我担任其辩护人。
现根据事实和法律，发表如下辩护意见：

    一、关于量刑情节
    **被申请人人**王某系初犯、偶犯，且在**归案后如实供述自己的罪行**，
依照《中华人民共和国刑法》第六十七条第三款之规定，属于**坦白**，
**可以从轻处罚**。

    二、关于量刑建议
    **被申请人人**王某犯罪情节较轻，有**悔罪表现**，且已积极赔偿被害人
损失并取得谅解，符合《中华人民共和国刑法》第七十二条规定的**缓刑**
适用条件，建议对**被申请人人**王某**宣告缓刑**。

    三、关于民事赔偿情况
    **被申请人人**王某已向被害人赔偿医疗费、误工费等各项经济损失共计
**人民币壹拾万元整（¥100,000.00）**，并已取得被害人出具的谅解书。

    综上所述，辩护人恳请仲裁庭综合考虑上述情节，依法对**被申请人人**
王某**从轻处罚**并**适用缓刑**。
...
1. **"犯罪嫌疑人"→"被申请人人"** `[置信度：确定]`
   审判阶段的法定称谓为"被申请人人"。这是刑事诉讼中最基本的术语规范，错误使用将导致辩护词的专业性严重受损。
...
4. **"精神赔偿金"的处理** `[置信度：高]`
   修正后文本中删除了"精神赔偿金"的表述，因为根据《最高人民法院关于适用〈中华人民共和国刑事诉讼法〉的解释》第175条第2款，刑事附带仲裁中一般不支持精神损害赔偿请求。如被害人确需主张精神损害赔偿，应另行提起仲裁。
