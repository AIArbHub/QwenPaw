...
1. 从用户问题、附件或工作区文件中定位待解释条文、相邻条文、所在编章和相关上位规范。
2. 建立体系位置表：同条款内部结构、同章规则、同法相关制度、同部门法规则、基本原则。
3. 对每个体系资源说明其支持宽解释、窄解释、排除适用还是补强限制。
4. 若体系解释与目的解释、文义解释发生张力，输出冲突点和待进一步核验资料。
