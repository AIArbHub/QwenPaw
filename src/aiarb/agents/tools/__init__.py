# -*- coding: utf-8 -*-
"""Built-in tool functions for AIArb agents.
...
are intentionally not re-exported — aiarb's react_agent does not
...
from .search_knowledge import search_knowledge  # noqa: E402
...
from .research_ima import research_ima  # noqa: E402
from .case_framework_tools import (  # noqa: E402
    identify_case_type,
    generate_review_checklist,
    dual_perspective_analysis,
    legal_qa_consultation,
)
from .case_analysis_tools import (  # noqa: E402
...
_STABLE_BROWSER_MODULE = (
    "aiarb.agents.tools.deprecated_browser.browser_control"
)
...
async def shutdown_browser_runtime() -> None:
    ...
    unified_links = sys.modules.get("aiarb.browser.runtime.links")
