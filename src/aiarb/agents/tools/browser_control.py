...
def _tool_response(text: str) -> ToolChunk:
    """Wrap text for the framework Toolkit (return ToolChunk)."""
    return ToolChunk(
        is_last=True,
...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs AIArb (e.g. "
...
async def stop_browsers_for_workspace_dirs(
    ...
    directories. It releases AIArb-owned Playwright/Chromium handles without
...
async def browser_use(  # pylint: disable=R0911,R0912
    ...
    Args:
        ...
        cdp_port (int):
            ...
            AIArb chooses a free local port automatically for managed CDP.
        private_mode (bool):
            ...
            via CDP. Default False. By default, AIArb prefers managed CDP for
