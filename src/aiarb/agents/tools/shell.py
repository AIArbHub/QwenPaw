...
from aiarb.framework.message import TextBlock, ToolResultState
...
def _execute_subprocess_sync(
    ...
    try:
        ...
        stdout_fd, stdout_path = tempfile.mkstemp(prefix="aiarb_out_")
        stderr_fd, stderr_path = tempfile.mkstemp(prefix="aiarb_err_")
