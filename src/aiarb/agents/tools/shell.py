...
# Configurable via environment variable AIARB_SHELL_MAX_OUTPUT_BYTES.
_SHELL_MAX_DISK_BYTES: int = int(
    os.environ.get("AIARB_SHELL_MAX_OUTPUT_BYTES", 10 * 1024 * 1024),
)
...
def _execute_subprocess_sync(
    ...
    try:
        ...
        if sys.platform == "win32":
            ...
            stdout_file, stdout_path = _open_temp_output("aiarb_out_")
            stderr_file, stderr_path = _open_temp_output("aiarb_err_")
