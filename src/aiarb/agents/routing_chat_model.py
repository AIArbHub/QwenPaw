...
from aiarb.framework.formatter import FormatterBase
from aiarb.framework.model import ChatModelBase
from aiarb.framework.model import ChatResponse
...
class RoutingChatModel(ChatModelBase):
    ...
    def __init__(
        ...
        *,
        ...
        # the framework 2.0 ChatModelBase requires credential/model/parameters;
    ...
    async def __call__(
        ...
        **kwargs: Any,
        ...
        # the framework 2.0 doesn't pass ``structured_model`` through ``__call__``
