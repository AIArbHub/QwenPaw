...
from aiarb.framework.message import AssistantMsg, Msg, TextBlock, ThinkingBlock
from aiarb.framework.message import ToolCallBlock, ToolCallState
from aiarb.framework.message import ToolResultBlock, ToolResultState
from aiarb.framework.message import Usage
...
class BaseMemoryManager(ABC):
    ...
    def build_middlewares(self) -> list[MiddlewareBase]:
        """Return the framework middlewares contributed by this manager.
