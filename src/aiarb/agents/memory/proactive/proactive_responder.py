...
from aiarb.framework.tool import FunctionTool, Toolkit
...
async def send_proactive_message_via_http(
    ...
    """Send a proactive message by directly calling the AIArb API."""
    ...
    try:
        ...
        logger.error(
            "Timeout (%ds) calling AIArb API for proactive message",
            timeout_seconds,
        )
    except Exception as e:
        logger.error("Error calling AIArb API for proactive message: %s", e)
