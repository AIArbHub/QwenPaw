# -*- coding: utf-8 -*-
"""Native the framework 2.0 middleware implementations for AIArb.
...
the framework's ``MiddlewareBase`` hooks.
...
class MemoryMiddleware(MiddlewareBase):
    """Attach long-term memory behavior to the framework 2.0 agents.
