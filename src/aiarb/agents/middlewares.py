# -*- coding: utf-8 -*-
"""Native AgentScope 2.0 middleware implementations for AIArb.
...
AUTO_MEMORY_TURN_STATE_KEY = "aiarb_auto_memory_turn_state"
_AUTOMATION_MEMORY_SKIP_SOURCES = frozenset({"cron", "heartbeat"})
_TOOL_RESULT_METADATA_KEY = "aiarb_tool_result_metadata"
    ...
    * post-reply auto-memory scheduling
    ...
    def _message_tag(msg: "Msg") -> str:
        ...
        if not isinstance(metadata, dict):
            return ""
        return str(metadata.get(AIARB_MESSAGE_TAG_KEY) or "")
