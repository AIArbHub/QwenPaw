...
class RedactionPipeline:
    ...
    def process_text(self, text: str, policy_name: str = "external_client",
                     ...
                     strength_level: Optional[str] = None) -> Dict[str, Any]:
        """
        对纯文本执行脱敏。
        ...
        Args:
            ...
            entity_types: 指定实体类型
            page_number: 页码
            strength_level: 强度级别 L1/L2/L3/L4，优先于 policy_name
        ...
        # Step 2: 应用策略
        policy = RedactionPolicyEngine(
            policy_name, custom_rules, strength_level=strength_level,
        )
    ...
    def process_ldir(self, ldir_path: str, matter_id: str,
        ...
        # 应用策略
        policy = RedactionPolicyEngine(policy_name, custom_rules, strength_level=strength_level)
        mappings = policy.create_mapping(entities)
