...
def _looks_like_project_path(value: str) -> bool:
    """Return True for path-like CLI tokens intended for ``aiarb`` TUI."""
...
@click.group(
    ...
    lazy_subcommands={
        "acp": ("aiarb.cli.acp_cmd", "acp_cmd", ".acp_cmd"),
        "app": ("aiarb.cli.app_cmd", "app_cmd", ".app_cmd"),
        "hub": ("aiarb.cli.hub_cmd", "hub_cmd", ".hub_cmd"),
        "channels": (
            "aiarb.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("aiarb.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("aiarb.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("aiarb.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("aiarb.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("aiarb.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("aiarb.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("aiarb.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "aiarb.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("aiarb.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "tui": ("aiarb.cli.tui.launch", "tui_cmd", ".tui.launch"),
        "uninstall": (
            "aiarb.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("aiarb.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("aiarb.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "aiarb.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("aiarb.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("aiarb.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("aiarb.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "plugin": (
            "aiarb.cli.plugin_commands",
            "plugin",
            ".plugin_commands",
        ),
        "task": ("aiarb.cli.task_cmd", "task_cmd", ".task_cmd"),
        "doctor": ("aiarb.cli.doctor_cmd", "doctor_cmd", ".doctor_cmd"),
        "auto": ("aiarb.cli.auto", "auto_group", ".auto"),
    },
)
@click.version_option(version=__version__, prog_name="AIArb")
...
def cli(ctx: click.Context, host: str | None, port: int | None) -> None:
    ...
    # Bare ``aiarb`` (no subcommand) opens the interactive terminal chat UI.
