# -*- coding: utf-8 -*-
"""CLI command: run AIArb app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run AIArb app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing AIArb app instance.
    """
    ...
    click.echo(f"Starting AIArb app on {url} (port {port})")
