# -*- coding: utf-8 -*-
"""Persist provider-neutral third-party turns in AIArb sessions."""
...
class HarnessSessionBridge:
    ...
    async def has_history(
        ...
        *,
        ...
        """Return whether AIArb already has a materialized transcript."""
    ...
    async def hydrate(
        ...
        *,
        ...
        """Save recovered provider history when no AIArb context exists."""
