...
class VoiceChannelConfig(BaseChannelConfig):
    ...
    language: str = "en-US"
    welcome_greeting: str = "Hi! This is AIArb. How can I help you?"
...
class SIPChannelConfig(BaseChannelConfig):
    ...
    language: str = "zh-CN"
    welcome_greeting: str = "你好，我是AIArb"
...
AGENT_MAIL_CREDENTIAL_REF = "mail/aiarbmail"
...
def migrate_legacy_config_to_multi_agent() -> bool:
    ...
    default_agent_config = AgentProfileConfig(
        id="default",
        name="Default Agent",
        description="Default AIArb agent",
