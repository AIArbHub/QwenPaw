...
class LlamaCppBackend:
    """
    AIArb local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"aiarb-llamacpp-download-{staging_dir.name}",
            command=["aiarb-llamacpp-download", download_url],
