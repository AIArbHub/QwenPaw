# -*- coding: utf-8 -*-
"""Plugin–AIArb version compatibility check.
...
def check_plugin_version_compat(
    ...
    """Check whether a plugin is compatible with the running AIArb.
    ...
    #     msg = (
    #         f"requires AIArb >={min_v}, <{max_v}, current is {current}"
    #     )
    #     return False, msg
    # return True, ""
    if current < min_v:
        msg = f"requires AIArb >={min_v}, current is {current}"
        return False, msg
