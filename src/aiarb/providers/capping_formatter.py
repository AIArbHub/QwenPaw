...
the framework's chat formatters (OpenAI, Anthropic, Gemini, DashScope, …) all
...
# The capping formatters below override the framework's ``_format_*_source``
...
from aiarb.framework.formatter import (
...
from aiarb.framework.message import Base64Source, URLSource
