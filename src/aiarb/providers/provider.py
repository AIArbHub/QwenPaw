...
class ProviderInfo(BaseModel):
    ...
    chat_model: str = Field(
        ...
        description="the framework ChatModel name (e.g., 'OpenAIChatModel')",
    )
    ...
    generate_kwargs: Dict[str, Any] = Field(
        default_factory=dict,
        description="Generation parameters for the framework chat models.",
    )
...
class Provider(ProviderInfo, ABC):
    ...
    def get_chat_model_cls(self) -> Type[ChatModelBase]:
        ...
        import aiarb.framework.model

        chat_model_cls = getattr(
            aiarb.framework.model,
            self.chat_model,
            None,
        )
