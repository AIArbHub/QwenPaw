...
_STREAM_FIRST_CONTENT_TIMEOUT_ENV = "AIARB_LLM_STREAM_FIRST_CONTENT_TIMEOUT"
_STREAM_IDLE_TIMEOUT_ENV = "AIARB_LLM_STREAM_IDLE_TIMEOUT"
...
def _enable_reasoning_content_fallback(
    ...
    while pending:
        ...
        if formatter is not None and getattr(
            formatter,
            "_aiarb_supports_reasoning_content_fallback",
            False,
        ):
            if getattr(
                formatter,
