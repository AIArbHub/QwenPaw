# -*- coding: utf-8 -*-
"""DashScope provider using the framework 2.0 native ``DashScopeChatModel``.
...
class DashScopeProvider(OpenAIProvider):
    ...
    def get_chat_model_instance(self, model_id: str) -> ChatModelBase:
        from aiarb.framework.credential import DashScopeCredential
        from aiarb.framework.model import DashScopeChatModel

        if not self.api_key:
            from aiarb.exceptions import ProviderError
