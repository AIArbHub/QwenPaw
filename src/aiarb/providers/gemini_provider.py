# -*- coding: utf-8 -*-
"""A Google Gemini provider implementation using the framework's native
GeminiChatModel."""
...
from aiarb.providers.multimodal_prober import (
    ProbeResult,
    _PROBE_IMAGE_B64,
    _IMAGE_PROBE_PROMPT,
    _PROBE_VIDEO_URL,
...
from aiarb.providers.provider import ModelInfo, Provider
...
#  the framework >= 2.0.5 is released (these are upstreamed into
...
class GeminiProvider(Provider):
    ...
    def get_chat_model_instance(self, model_id: str) -> ChatModelBase:
        from aiarb.framework.credential import GeminiCredential
        from aiarb.framework.model import GeminiChatModel
...
class _GeminiChatModelCompat:
    ...
    def __new__(cls, **kwargs: Any) -> Any:
        ...
        class _Compat(GeminiChatModel):
            ...
            # TODO: Remove this override once the framework >= 2.0.5 is
