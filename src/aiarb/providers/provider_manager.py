...
from aiarb.exceptions import ModelNotFoundException
...
class ProviderManager:  # pylint: disable=too-many-public-methods
    ...
    def _init_builtins(self):
        self._add_builtin(PROVIDER_AIARB)
    ...
    def _normalize_provider_id(provider_id: str) -> str:
        ...
        Maps legacy 'copaw-local' to 'aiarb-local'.
        """
    ...
    def _migrate_copaw_config(self) -> None:
        ...
        try:
            ...
            provider = self.builtin_providers.get("aiarb-local")
            if not provider:
                return
            ...
            logger.info(
                ...
                "'copaw-local.json' to 'aiarb-local.json'",
            )
            ...
            if active_model:
                try:
                    ...
                    if active_model.get("provider_id") == "copaw-local":
                        active_model["provider_id"] = "aiarb-local"
    ...
    def _init_from_storage(self):
        ...
        # Migrate copaw-local to aiarb-local for backwards compatibility
    ...
    async def _resume_local_model(self, local_manager) -> None:
        ...
        local_models = self.get_provider("aiarb-local").extra_models
