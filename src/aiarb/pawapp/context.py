...
Provides access to AIArb capabilities via thin delegation:
...
@dataclass
class PawAppContext:
    """The ``ctx`` object — PawApp developer's gateway to AIArb.
    ...
    async def get_session_history(
        ...
        try:
            ...
            # Convert the framework Msg to standard Message
            from ..app.chats.utils import framework_msg_to_message
            ...
            standard_messages = framework_msg_to_message(msg_list)
