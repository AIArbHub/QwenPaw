...
PLUGIN_DOWNLOAD_CDN = "https://download.aiarb.agentscope.io"
_FETCH_TIMEOUT = 30
...
def _is_entry_compatible(entry: dict[str, Any]) -> bool:
    """Return True when a CDN index entry supports the running AIArb.

    Checks the structured ``aiarb_version`` field first, then falls
    ...
    manifest_data: dict[str, Any] = {
        "id": plugin_id,
        "version": version,
        "aiarb_version": version_constraint,
    }
