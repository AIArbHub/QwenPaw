...
class ToolGovernanceSpec:
    ...
    ``aiarb.agents.tools`` (treated as a governance gap). Dynamic tools
...
_BUILTIN_TOOLS_PREFIX = "aiarb.agents.tools."
...
def tool_descriptor(
    ...
    **metadata: Any,
    ...
    Built-in tools (under ``aiarb.agents.tools``) are automatically
