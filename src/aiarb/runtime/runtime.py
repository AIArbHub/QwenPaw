...
class Runtime:
    ...
    def _inject_partial_response(agent: Any, envelope: Any) -> None:
        ...
        2. **Dangling tool calls** — the framework's
        ...
        try:
            from aiarb.framework.message import TextBlock, ThinkingBlock
    ...
    def _close_dangling_tool_calls(agent: Any, envelope: Any) -> int:
        ...
        the framework's ``_close_unfinished_tool_calls`` patches the context
