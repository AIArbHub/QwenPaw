...
Translates the framework ``EventType`` events into the frontend's
...
class Envelope:
    ...
    async def translate_event(  # noqa: C901, PLR0912, PLR0915
        ...
        """Translate an the framework event into real-time Host objects."""
        ...
        # ``EventType.HINT_BLOCK`` does not exist in every the framework version;
