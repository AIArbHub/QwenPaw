# -*- coding: utf-8 -*-
"""AIArb streaming envelope schema.
...
aiarb's own envelope protocol — independent of the framework's internal
event types.
"""
...
# ---------------------------------------------------------------------------
# Message envelope.
# aiarb's runner constructs an empty ``Message`` then calls
...
# These are constructed by aiarb rather than parsed from external input
