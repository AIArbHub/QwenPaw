...
const messages = {
  en: {
    routeLabel: "Chrome",
    pageTitle: "Chrome",
    pageSubtitle: "Connect AIArb to this Chrome browser.",
    ...
    localMethodDescription:
      "Use the extension files included with AIArb for this local browser.",
    ...
    aiarbExtensionPath: "Copy AIArb extension path",
    ...
    shortcutCopyPathSuffix:
      "button to copy the AIArb extension path to your clipboard.",
    shortcutMacStep1:
    ...
    stepLoad: "Choose Load unpacked and select the AIArb extension folder.",
    stepVerify: "Return here and refresh the status.",
    directoryLabel: "AIArb built-in extension folder",
    ...
    chrome_action_runtime_missing:
      "Restart AIArb or reload the Chrome plugin.",
  ...
  zh: {
    ...
    pageTitle: "Chrome",
    pageSubtitle: "将 AIArb 连接到此 Chrome 浏览器。",
    ...
    recommendedBadge: "推荐",
    localMethodDescription: "使用 AIArb 自带扩展文件连接当前本地浏览器。",
    ...
    stepLoad: "选择“加载未打包的扩展程序”，并选择 AIArb 扩展目录。",
    stepVerify: "回到此页面并刷新状态。",
    directoryLabel: "AIArb 自带扩展目录",
    ...
    chrome_action_runtime_missing: "重启 AIArb，或重新加载 Chrome 插件。",
