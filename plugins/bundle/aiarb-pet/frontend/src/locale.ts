/** Pet plugin UI locale — follows AIArb console ``localStorage.language``. */
...
const messages = {
  en: {
    ...
    title: "AIArb Pet",
    intro:
      "Installed pets live under your AIArb working directory. Start the desktop bridge, then switch the floating pet without restarting AIArb.",
    ...
    colAction: "Action",
    switch: "Switch",
    tableEmpty: "No pets found. Run: aiarb-pet install-pet …",
  ...
  zh: {
    ...
    title: "AIArb 桌面宠物",
    intro:
      "已安装的宠物位于 AIArb 工作目录下。启动桌面桥接后，可在不重启 AIArb 的情况下切换悬浮宠物。",
    startDesktop: "启动桌面宠物",
    importPet: "导入宠物",
    refresh: "刷新",
    petsDirectory: "宠物目录：",
    ...
    colAction: "操作",
    switch: "切换",
    tableEmpty: "未找到宠物。请运行：aiarb-pet install-pet …",
...
/** Map AIArb console language to pet UI locale (non zh/en → en). */
