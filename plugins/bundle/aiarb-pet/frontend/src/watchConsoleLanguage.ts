/** AIArb console stores UI language in ``localStorage.language``. */

const LANGUAGE_KEY = "language";
const LANGUAGE_EVENT = "aiarb-pet-language-change";
...
function installLanguageSetItemHook(): void {
  const marker = "__aiarbPetLanguageHook";
...
/** Subscribe to AIArb header language switcher (no console changes needed). */
