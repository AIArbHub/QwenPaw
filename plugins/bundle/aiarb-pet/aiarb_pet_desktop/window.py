        ...
        try:
            ...
            req = urllib.request.Request(
                ...
                headers={
                    ...
                    **({"X-AIArb-Pet-Token": self._token} if self._token else {}),
                },
                method="POST",
            )
...
class ChatBubbleWidget(QWidget):
    ...
    def _send_message(self) -> None:
        ...
        import os
        base_url = os.environ.get("AIARB_API_BASE", "http://127.0.0.1:26740")
        url = f"{base_url}/api/aiarb-pet/chat"
...
class PetWindow(QWidget):
    ...
    def _apply_bubble_text(
        ...
        if text or ev_name in ("idle", "aiarb.shutdown"):
    ...
    def _open_menu(self, pos: QPoint) -> None:
        menu = QMenu(self)
        title = self.manifest.get("displayName", "AIArb Pet")
