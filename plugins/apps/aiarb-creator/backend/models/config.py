...
Environment variables remain the standalone/local fallback, while AIArb
...
def _get_model_config_path() -> Path:
    ...
    return Path("/__aiarb_creator_unconfigured__/model_config.json")
...
def _get_skills_config_path() -> Path:
    ...
    return Path("/__aiarb_creator_unconfigured__/skills_config.json")
