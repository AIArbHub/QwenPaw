...
Prerequisites
-------------
The script loads ``plugins/app/aiarb-creator/.env`` automatically. Configure
...
Recommended identity smoke::
    ...
    python plugins/app/aiarb-creator/backend/scripts/smoke_web_grounding.py \
      --prompt "哈兰德参加偶像练习生" \
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    data_root = args.data_root or Path(
        tempfile.mkdtemp(prefix="aiarb-grounding-smoke-"),
    )
