...
function MotionOverlayLayer({
  ...
  useEffect(() => {
    ...
    iframeRef.current?.contentWindow?.postMessage(
      { type: "aiarb-motion-seek", seconds: localTimeMs / 1000 },
      "*",
    );
