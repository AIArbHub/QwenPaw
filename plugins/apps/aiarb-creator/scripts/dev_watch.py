#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""dev_watch.py — Watch creator sources and hot-sync into a running AIArb.
...
WORKING_DIR = os.path.expanduser(
    os.environ.get("AIARB_WORKING_DIR", "~/.aiarb"),
)
PORT = os.environ.get("AIARB_PORT", "8088")
INSTALLED_DIR = os.path.join(WORKING_DIR, "plugins", "aiarb-creator")
POLL_SECONDS = 1.0
