...
class McpPage(BasePage):
    ...
    CREATE_BTN_SELECTOR = 'button.aiarb-btn-primary:has-text("创建客户端")'
    ...
    # Create dialog
    MODAL_CONTENT_SELECTOR = '.aiarb-modal-content'
    MODAL_TITLE_SELECTOR = '.aiarb-spark-modal-title'
