...
class InboxPage(BasePage):
    ...
    TAB_PUSH = (
        '.aiarb-tabs-tab:has-text("Push Messages"), '
        '.aiarb-tabs-tab:has-text("推送消息")'
    )
    TAB_APPROVALS = (
        '.aiarb-tabs-tab:has-text("Approvals"), '
        '.aiarb-tabs-tab:has-text("审批")'
    )
    ...
    # rendered as <sup class="aiarb-badge-dot"> inside the menu title.
    # data-menu-id is auto-generated by rc-menu (e.g. "rc-menu-uuid-N-inbox"),
    # so we anchor on the bilingual menu label instead.
    SIDEBAR_INBOX_BADGE = (
        'li.aiarb-menu-item:has(span.aiarb-menu-title-content:has-text("Inbox")) '
        '.aiarb-badge-dot, '
        'li.aiarb-menu-item:has(span.aiarb-menu-title-content:has-text("收件箱")) '
        '.aiarb-badge-dot'
    )

    # Detail modal
    DETAIL_MODAL = '.aiarb-modal'
    ...
    POPCONFIRM_OK = (
        ...
        '.aiarb-popover button.aiarb-btn-primary'
    )
    ...
    CARD_DELETE_BTN = 'button.aiarb-btn-dangerous'
