# -*- coding: utf-8 -*-
"""
AIArb E2E test framework - Page Object base class.
...
class BasePage:
    ...
    SUCCESS_MESSAGE = '.ant-message-success, .aiarb-message-success, .aiarb-notification-success'
    ERROR_MESSAGE = '.ant-message-error, .aiarb-message-error, .aiarb-notification-error'
    LOADING_SPINNER = '.ant-spin, .aiarb-spin, [class*=loading]'
    ...
    def step_shot(self, action: str, full_page: bool = False) -> str:
        ...
        - The test case name is passed through page._aiarb_test_name (injected by conftest).
        ...
        try:
            ...
            test_name = getattr(self.page, "_aiarb_test_name", None) or "unknown_test"
            ...
            seq = getattr(self.page, "_aiarb_step_seq", 0) + 1
            try:
                self.page._aiarb_step_seq = seq
            except Exception:
                pass
