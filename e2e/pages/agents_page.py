...
class AgentsPage(BasePage):
    ...
    AGENT_DESC_CELL = 'td.aiarb-table-cell:nth-child(4)'
    AGENT_WORKSPACE_CELL = 'td.aiarb-table-cell:nth-child(5)'
    AGENT_MODEL_CELL = 'td.aiarb-table-cell:nth-child(6)'
    AGENT_ACTIONS_CELL = 'td.aiarb-table-cell:nth-child(7)'
    ...
    TOGGLE_BTN = 'button:has(svg.lucide-eye-off), button:has(svg.lucide-eye), .aiarb-space-item:nth-child(3) button'
    DELETE_BTN = 'button.aiarb-btn-dangerous, button:has(.anticon-delete)'
    ENABLE_TOGGLE = 'button:has(svg.lucide-eye-off), button:has(svg.lucide-eye), .aiarb-space-item:nth-child(3) button'
