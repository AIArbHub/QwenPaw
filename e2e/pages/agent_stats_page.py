# -*- coding: utf-8 -*-
"""
AIArb AgentStats agent statistics page object.
...
class AgentStatsPage(BasePage):
    ...
    # Date range picker
    DATE_RANGE_PICKER = ".aiarb-picker-range, .aiarb-picker"
    DATE_RANGE_INPUT = ".aiarb-picker-range input, .aiarb-picker input"
    DATE_PICKER_PANEL = ".aiarb-picker-panel, .aiarb-picker-dropdown"

    # Summary cards
    SUMMARY_CARD = '[class*="summaryCard"], [class*="SummaryCard"], .aiarb-card'
    SUMMARY_CARD_TITLE = '[class*="cardTitle"], [class*="title"], .aiarb-statistic-title'
    SUMMARY_CARD_VALUE = '[class*="cardValue"], [class*="value"], .aiarb-statistic-content-value'
    ...
    def get_card_title(self, card: Locator) -> str:
        ...
        title_el = card.locator(
            '[class*="title"], .aiarb-statistic-title, h3, h4, span'
        ).first
    ...
    def get_card_value(self, card: Locator) -> str:
        ...
        value_el = card.locator(
            '[class*="value"], .aiarb-statistic-content-value, '
