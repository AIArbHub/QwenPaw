...
$ConsoleDest = Join-Path $RepoRoot "src\aiarb\console"
...
Write-Host "[wheel_build] Copying console/dist/* -> src/aiarb/console/..."
...
$DocsDest = Join-Path $RepoRoot "src\aiarb\docs"
