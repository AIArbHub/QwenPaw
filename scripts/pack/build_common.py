...
"""
Create a temporary conda env, install AIArb from a wheel, run conda-pack.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack AIArb (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        # Install aiarb with all dependencies
        ...
        # aiarb[full]. Restore conda-managed packaging tools before packing.
        _run(
            [
                conda,
                "run",
