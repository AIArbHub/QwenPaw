...
One-click analysis of AIArb startup performance, identify bottlenecks, and provide optimization suggestions.
...
- **Import Time Analysis** - AIArb modules and third-party library import time ranking
...
2. **Data Analysis**
   - Parse log files
   - Categorize statistics (AIArb/third-party/stdlib)
...
- Python 3.8+
- No extra dependencies (except AIArb itself)
- Pure JSON data output
- HTML runs standalone, viewable offline

## Related Tools

- `src/aiarb/utils/startup_display.py` - Startup banner display
