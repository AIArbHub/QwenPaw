#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for AIArb."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in aiarb package."""
...
def main():
    """Run tracer on aiarb app import."""
    ...
    tracer = ExecTracer(package_names=["aiarb"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import aiarb app to trigger startup
        from aiarb.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
