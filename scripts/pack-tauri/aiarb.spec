...
datas += collect_data_files("the framework")
datas += collect_data_files(
    "the framework.tool._builtin._scripts",
    include_py_files=True,
)
datas += collect_data_files(
    "the framework.workspace._mcp_gateway",
    include_py_files=True,
)
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        *collect_submodules("the framework.tool._builtin._scripts"),
        *collect_submodules("the framework.workspace._mcp_gateway"),
